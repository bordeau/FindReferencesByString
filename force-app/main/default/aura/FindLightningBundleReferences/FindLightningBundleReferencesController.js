           ...
           debugger;
            ...
            for( var x=0; x<jj.length; x++ ) {
                ...
                if ( vz.t == "lc" ) 
                    ...
                    + vz.ml + '&amp;defType=component" target="_blank">' + vz.ml + '</a> '  + vz.dt + ' </li>';
                else if ( vz.t == "so")
                    aa = '<li class="slds-item"><a href="/auradocs/reference.app#reference?descriptor=c:'
                    + vz.src + '&amp;defType=component" target="_blank">' + vz.src + '</a> ' +  vz.tz + ' sobject: <a href="/lightning/setup/ObjectManager/' + vz.ml + '/Details/view'  + 
